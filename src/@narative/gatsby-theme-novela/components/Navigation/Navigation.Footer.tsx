...
import FooterPages from "../../../../Custom/FooterPages"
...
const Footer: React.FC<{}> = () => {
  ...
  const { name, social, footerLinks } = results.allSite.edges[0].node.siteMetadata;
    ...
    <>
      ...
      <Section narrow>
        ...
        <FooterContainer>
          ...
          <div>
            <FooterPages pages={footerLinks}></FooterPages>
          </div>
          <div>
